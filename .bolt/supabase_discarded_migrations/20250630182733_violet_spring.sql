-- BoltShop E-commerce Platform Database Schema
-- This file contains the complete database schema for the BoltShop e-commerce platform.
-- It creates all necessary tables, types, functions, triggers, and policies.
...
-- Add foreign key for featured_image_id after product_images table is created
