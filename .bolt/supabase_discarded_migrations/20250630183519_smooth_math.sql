/*
  # BoltShop E-commerce Database Schema
  
  This file contains the complete database schema for the BoltShop e-commerce platform.
  It creates all necessary tables, types, functions, triggers, and security policies.
  ...
  6. Inventory Management:
     - inventory_transactions: Stock change tracking
...
-- Create function to update review reported status
...
-- Create trigger for review helpful votes
CREATE TRIGGER update_helpful_count_on_vote
  AFTER INSERT OR DELETE ON review_helpful_votes
  FOR EACH ROW
  EXECUTE FUNCTION update_review_helpful_count();

-- Create trigger for review reports
...
VALUES 
  ...
  ('store_address', '{"street": "123 Fashion Ave", "city": "New York", "state": "NY", "zip": "10001", "country": "US"}'::jsonb),
...
INSERT INTO payment_processors (
  ...
  '[{"url": "/api/webhooks/stripe", "events": ["payment_intent.succeeded", "payment_intent.payment_failed"]}]'::jsonb,
