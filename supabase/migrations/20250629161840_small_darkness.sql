/*
  ...
  1. New Tables
    ...
    - `discount_redemptions` - Track discount usage by customers
    - `discount_products` - Link discounts to specific products (optional)
    - `discount_categories` - Link discounts to specific categories (optional)
